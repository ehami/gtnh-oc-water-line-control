...
local function guiLoop()
  gui:render({
    ...
    t4success = string.format("%3d", controllerSuccesses["t4"]),
    t5success = string.format("%3d", controllerSuccesses["t5"]),
    t6success = string.format("%3d", controllerSuccesses["t6"]),
    t7success = string.format("%3d", controllerSuccesses["t7"]),
    t8success = string.format("%3d", controllerSuccesses["t8"]),
    t1waterLevel = string.format("%8d / %8d kL", math.floor(config.quantityController.waterLevels[1]/1000), math.floor(config.quantityController.waterThresholds[1]/1000)),
    t2waterLevel = string.format("%8d / %8d kL", math.floor(config.quantityController.waterLevels[2]/1000), math.floor(config.quantityController.waterThresholds[2]/1000)),
    t3waterLevel = string.format("%8d / %8d kL", math.floor(config.quantityController.waterLevels[3]/1000), math.floor(config.quantityController.waterThresholds[3]/1000)),
    t4waterLevel = string.format("%8d / %8d kL", math.floor(config.quantityController.waterLevels[4]/1000), math.floor(config.quantityController.waterThresholds[4]/1000)),
    t5waterLevel = string.format("%8d / %8d kL", math.floor(config.quantityController.waterLevels[5]/1000), math.floor(config.quantityController.waterThresholds[5]/1000)),
    t6waterLevel = string.format("%8d / %8d kL", math.floor(config.quantityController.waterLevels[6]/1000), math.floor(config.quantityController.waterThresholds[6]/1000)),
